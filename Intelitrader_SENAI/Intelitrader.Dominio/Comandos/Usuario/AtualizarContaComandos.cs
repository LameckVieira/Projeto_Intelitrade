...
{
    public class AtualizarContaComandos : Notifiable<Notification>, IComandos
    {
        public AtualizarContaComandos()
        {

        }

        public AtualizarContaComandos(Guid idConta, string nome, string email, string telefone, string cPF, string foto, string rG, string curriculo, string senha, EnTipoUsuario tipoUsuario)
        {
            IdConta = idConta;
            Nome = nome;
            Email = email;
